...
object FDroidConfig {
  ...
  fun load(project: Project) {
    ...
    aapt2Files = mutableMapOf<String, String?>().also { files ->
      files[PROP_FDROID_AAPT2FILE_ARM64.substringAfterLast('.')] = properties.getProperty(PROP_FDROID_AAPT2FILE_ARM64, null)
      files[PROP_FDROID_AAPT2FILE_ARM.substringAfterLast('.')] = properties.getProperty(PROP_FDROID_AAPT2FILE_ARM, null)
      files[PROP_FDROID_AAPT2FILE_X86_64.substringAfterLast('.')] = properties.getProperty(PROP_FDROID_AAPT2FILE_X86_64, null)
    }
  }
}
